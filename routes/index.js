...
router.post('/add', (req, res) => {
    ...
    newUser.save().then((result) => {
        // console.log(result);
        res.render('addUser', { title: "Sucess", msg: 'User Successfully Added...' })
    }).catch(err => {
        console.log(err)
    })
        ...
        if (err) {
            ...
            adata.forEach((a) => {
                if (a.name != reciverName || a.email != reciverEmail) {
                    res.render('success', { title: "sucess", errmsg: "Reciver Details Not Matched!", value: "", msg: "" })
                } else {
                                ...
                                if (err) {
                                    ...
                                    sdata.forEach(async (e) => {
                                        if (e.amount < sendAmount || e.name === reciverName) {
                                            ...
                                            res.render('success', { title: "sucess", errmsg: "Not Proceed Due TO Incorrect Information", value: "", msg: "" })
                                        }
                                        else {
                                            ...
                                            res.render('success', { title: "sucess", msg: "Transaction Sucessfully Done!", value: "true" })
                                        }
                                    })
                                }
                            })
